...
def main():
    ...
    if option == 1:
        ...
        capture1 = cv2.VideoCapture("http://10.130.5.86:4747/video")   # sample code for mobile camera video capture using IP camera
        capture2 = cv2.VideoCapture("http://10.130.8.208:4747/video")
        capture3 = cv2.VideoCapture("http://10.130.138.68:4747/video")
        ...
        capture1 = cv2.VideoCapture("http://10.130.5.86:4747/video")
        capture2 = cv2.VideoCapture("http://10.130.8.208:4747/video")
        capture3 = cv2.VideoCapture("http://10.130.138.68:4747/video")
